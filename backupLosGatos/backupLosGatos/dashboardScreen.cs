...
namespace backupLosGatos
{
    public partial class dashboardScreen : Form
    {
        ...
        private void dashboardGrid_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            viewTicket.ticketIDTextBox.Text = this.dashboardScreenGrid.CurrentRow.Cells[0].Value.ToString();
            viewTicket.unitIDTextBox.Text = this.dashboardScreenGrid.CurrentRow.Cells[1].Value.ToString();
            viewTicket.equipmentIDTextBox.Text = this.dashboardScreenGrid.CurrentRow.Cells[2].Value.ToString();
            viewTicket.dateSubmittedDateTimePicker.Text = this.dashboardScreenGrid.CurrentRow.Cells[3].Value.ToString();
            viewTicket.priorityComboBox.Text = this.dashboardScreenGrid.CurrentRow.Cells[4].Value.ToString();
            viewTicket.statusComboBox.Text = this.dashboardScreenGrid.CurrentRow.Cells[5].Value.ToString();
            viewTicket.welderSignatureTextBox.Text = this.dashboardScreenGrid.CurrentRow.Cells[6].Value.ToString();
            viewTicket.inspectorSignatureTextBox.Text = this.dashboardScreenGrid.CurrentRow.Cells[7].Value.ToString();
            viewTicket.additionalInformationTextBox.Text = this.dashboardScreenGrid.CurrentRow.Cells[8].Value.ToString();
        ...
        private void statusComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                dashboardScreenGrid.DataSource = ds.Tables[0];
